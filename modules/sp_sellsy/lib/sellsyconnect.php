...
class sellsyConnect_curl {
	...
	static $oauth_access_token			= "{{user_token}}";
	static $oauth_access_token_secret	= "{{user_secret}}";
	static $oauth_consumer_key			= "{{consumer_token}}";
	static $oauth_consumer_secret		= "{{consumer_secret}}";
