 ...
 */
return [
    Chocolatine\Pattern\Manager\ManagerConfiguration::class,
    Chocolatine\Pattern\Manager\ManagerAjax::class,
    Chocolatine\Pattern\Manager\ManagerAsset::class,
    Chocolatine\Pattern\Manager\ManagerError::class,
    Chocolatine\Pattern\Manager\ManagerForm::class,
